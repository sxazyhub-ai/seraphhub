-- SERAPH HUB - Muscle Legends (Full)
-- Key: seraph
...
AvatarFrame.BackgroundColor3 = Dark
AvatarFrame.Parent = LeftPanel
Instance.new("UICorner", AvatarFrame).CornerRadius = UDim.new(1,0)
Instance.new("UIStroke", AvatarFrame).Color = Red
...
local AccessBtn, AccessLabel = (function()
    local Btn = Instance.new("TextButton")
    Btn.Size = UDim2.new(0,300,0,45)
    Btn.Position = UDim2.new(0.5,0,0,220)
...
-- ==================== KEY SYSTEM + TU SCRIPT ====================

AccessBtn.MouseButton1Click:Connect(function()
    if KeyBox.Text == "seraph" then
        AccessLabel.Text = "ACCESS GRANTED"
        TweenService:Create(AccessBtn, TweenInfo.new(0.3), {BackgroundColor3 = Green}):Play()
        
        wait(0.8)
        TweenService:Create(MainFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {Size = UDim2.new(0,0,0,0), GroupTransparency = 1}):Play()
        wait(0.6)
        ScreenGui:Destroy()
        ...
        -- (Todo tu código original sigue aquí abajo)
