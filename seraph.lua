...
AccessBtn.MouseButton1Click:Connect(function()
    if KeyBox.Text == "seraph" then
        ...
        print("✅ SERAPH HUB B-N - Acceso concedido")
  local Players = game:GetService("Players")
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/sxazyhub-ai/librery2.0/refs/heads/main/librery.lua"))()

-- VENTANA PRINCIPAL
local window = library:AddWind"Hyperion HUB", {
    main_color = Color3.fromRGB(135, 206, 235), -- dark purple
    min_size = Vector2.new(380, 500),
    can_resize = false,
})
...
AutoFarm:AddSwitch("Anti AFK", function(state)
    if state then
        ...
        uselesslabelone.Text = "Anti Afk Z3R"
...
Credits:AddLabel("M3rCy")
Credits:AddLabel("like script ")
Credits:AddLabel("Discord Server:")
Credits:AddButton("Copy Link", function()
setclipboard("https://discord.gg/S4WcBZw9Em")
        end)
